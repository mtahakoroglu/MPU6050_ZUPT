...
class MPU6050{
  ...
  unsigned long MPU6050::getTimestamp() { return micros(); }
  ...
  uint16_t sample_rate_ = 0;  // Default to 0, meaning no specific rate set
  unsigned long last_update_;
  unsigned long timestamp_;
  // bool set_sample_rate_manually_;
};
